...
<head>
  <meta charset="UTF-8">
  <title>Nuestras villas - Casas Club Santiago</title>
...
<main class="page-main">
  <section class="section">
    ...
    <p class="muted-text">Villas especiales dentro de Club Santiago.</p>
  </section>
  ...
  <section class="section">
    ...
    <?php if ($res && $res->num_rows): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p class="muted-text">Aún no hay villas registradas.</p>
    <?php endif; ?>
  </section>
</main>
