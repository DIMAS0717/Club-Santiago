...
<main class="page-main">
  <section class="section">
    <h1>Alrededores</h1>
    <p class="muted-text">
      Aquí más adelante puedes mostrar fotos y descripciones de la playa, campo de golf,
      restaurantes cercanos, etc. Por ahora lo dejamos vacío para que no muestre nada raro.
    </p>
  </section>
</main>
